...
/**
 * Reusable controls content: wordmark/about, program toggle, layer list,
 * and TopDecreaseList. Rendered in the desktop cluster or mobile filters sheet.
 */
export function ControlsPanel({ showWordmark = true, onPinFromList }: ControlsPanelProps) {
  ...
  return (
    <>
      ...
      <TopDecreaseList onPinFromList={onPinFromList} />
